            ...
            <div class="flex flex-wrap justify-center gap-x-6 gap-y-8 sm:gap-x-8 lg:justify-between">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(route('product-catalog', ['selectCategory' => [$category->id]])); ?>" class="group flex w-28 flex-col items-center sm:w-32" title="<?php echo e($category->name); ?>">
                        ...
                        <span class="mt-4 text-center text-sm font-black uppercase leading-tight text-[#20221b] transition-colors group-hover:text-[#555a42]"><?php echo e($category->name); ?></span>
...
<div class="flex gap-2 overflow-x-auto scrollbar-hide">
                    <a href="<?php echo e(route('product-catalog')); ?>" class="inline-flex h-11 shrink-0 items-center rounded-full bg-[#555a42] px-5 text-xs font-bold text-white transition hover:bg-[#3f4331]">
                        <?php echo e(__('All')); ?>
