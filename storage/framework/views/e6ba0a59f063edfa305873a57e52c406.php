        ...
        <div class="mx-auto max-w-[92rem]">
            <div class="flex flex-col gap-3 rounded-[1.5rem] bg-white p-3 shadow-sm ring-1 ring-black/5 lg:flex-row lg:items-center">
                ...
                <div class="flex gap-2 overflow-x-auto scrollbar-hide">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ['Semua', 'Terbaru', 'Terlaris', 'Promo', 'Lifestyle', 'Harian']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('product-catalog')); ?>" class="inline-flex h-11 shrink-0 items-center rounded-full bg-[#f2f3ed] px-5 text-xs font-bold text-[#555a42] transition hover:bg-[#555a42] hover:text-white">
                            <?php echo e($category); ?>
...
<?php endif; ?>
    ...
    <section class="px-3 py-6 sm:px-5 lg:px-8">
        <div class="mx-auto grid max-w-[92rem] gap-4 lg:grid-cols-2">
            <a href="<?php echo e(route('product-catalog')); ?>" class="group relative min-h-64 overflow-hidden rounded-[1.5rem] bg-[#e6e8de] p-6 shadow-sm">
