<div class="bg-[#f7f7f2] text-[#20221b]">
    <section class="nexora-struct-hero-shell">
        ...
        <div class="nexora-struct-hero">
            ...
            <img class="nexora-struct-image" src="<?php echo e(asset('images/hero-outfit-women.png')); ?>" alt="Model wanita berambut panjang memakai outfit netral">
            ...
            <div class="nexora-struct-actions">
                <a class="nexora-struct-btn primary" href="<?php echo e(route('product-catalog')); ?>">Shop now</a>
    ...
    <section class="px-3 pt-14 pb-2 sm:px-5 lg:px-8">
        <div class="mx-auto max-w-[92rem]">
            <div class="mb-8 flex items-end justify-between gap-4">
                ...
                <a href="<?php echo e(route('product-catalog')); ?>" class="group hidden items-center gap-2 text-sm font-bold text-[#555a42] hover:text-[#20221b] sm:inline-flex">
                    Semua kategori
            ...
            <div class="flex flex-wrap justify-center gap-x-6 gap-y-8 sm:gap-x-8 lg:justify-between">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $catCover = $category->products()->first()?->getFirstMediaUrl('cover'); ?>
                    <a href="<?php echo e(route('product-catalog', ['selectCategory' => [$category->id]])); ?>" class="group flex w-28 flex-col items-center sm:w-32" title="<?php echo e($category->name); ?>">
                        <span class="relative block aspect-square w-full overflow-hidden rounded-full bg-[#e9e6dc] shadow-sm ring-1 ring-black/5 transition duration-300 group-hover:-translate-y-1.5 group-hover:shadow-lg group-hover:shadow-[#555a42]/15 group-hover:ring-[#c9c3b2]">
                            <!--[if BLOCK]><![endif]--><?php if($catCover): ?>
                                <img class="absolute inset-0 size-full object-cover transition duration-500 group-hover:scale-110" src="<?php echo e($catCover); ?>" alt="<?php echo e($category->name); ?>" loading="lazy">
                            <?php else: ?>
                        ...
                        <span class="mt-4 text-center text-sm font-black uppercase leading-tight text-[#20221b] transition-colors group-hover:text-[#551a1a]"><?php echo e($category->name); ?></span>
                        <span class="mt-1 text-[11px] font-bold uppercase tracking-[0.08em] text-[#8c9082]"><?php echo e($category->products_count); ?> produk</span>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->

                <a href="<?php echo e(route('product-catalog')); ?>" class="group flex w-28 flex-col items-center sm:w-32" title="Semua produk">
...
<div class="flex gap-2 overflow-x-auto scrollbar-hide">
                    <a href="<?php echo e(route('product-catalog')); ?>" class="inline-flex h-11 shrink-0 items-center rounded-full bg-[#551a1a] px-5 text-xs font-bold text-white transition hover:bg-[#3f4331]">
                        <?php echo e(__('All')); ?>

                    </a>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('product-catalog', ['selectCategory' => [$category->id]])); ?>" class="inline-flex h-11 shrink-0 items-center rounded-full bg-[#f2f3ed] px-5 text-xs font-bold text-[#555a42] transition hover:bg-[#555a42] hover:text-white">
    ...
    <section id="best-sellers" class="px-3 py-8 sm:px-5 lg:px-8">
        <div class="mx-auto max-w-[92rem]">
            <div class="mb-5 flex items-end justify-between gap-4">
                ...
                <a href="<?php echo e(route('product-catalog')); ?>" class="hidden items-center gap-2 text-sm font-bold text-[#555a42] hover:text-[#20221b] sm:inline-flex">
                    Semua produk
...
<section class="px-3 py-6 sm:px-5 lg:px-8">
        <div class="mx-auto grid max-w-[92rem] gap-4 lg:grid-cols-2">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('product-catalog', ['selectCategory' => [$category->id]])); ?>" class="group relative min-h-64 overflow-hidden rounded-[1.5rem] bg-[#e6e8de] p-6 shadow-sm">
                    <?php $cover = $category->products()->first()?->getFirstMediaUrl('cover'); ?>
                    <!--[if BLOCK]><![endif]--><?php if($cover): ?>
                        <img class="absolute inset-y-0 right-0 h-full w-2/3 object-cover transition duration-700 group-hover:scale-105" src="<?php echo e($cover); ?>" alt="<?php echo e($category->name); ?>">
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <div class="absolute inset-0 bg-gradient-to-r from-[#f3f4ee] via-[#f3f4ee]/80 to-transparent"></div>
                    <div class="relative max-w-xs">
                        <p class="text-xs font-black uppercase tracking-[0.14em] text-[#777c62]"><?php echo e($category->products_count); ?> produk</p>
                        <h3 class="mt-2 font-display text-3xl font-black uppercase text-[#20221b]"><?php echo e($category->name); ?></h3>
                        <p class="mt-3 text-sm leading-6 text-[#65685c]"><?php echo e($category->description ?? 'Jelajahi koleksi pilihan produk terkurasi.'); ?></p>
            ...
            <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [
                    ...
                    <div class="rounded-[1.25rem] bg-white p-5 text-center shadow-sm ring-1 ring-black/5">
                        ...
                        <h3 class="mt-4 text-sm font-black uppercase text-[#20221b]"><?php echo e($title); ?></h3>
                        <p class="mt-2 text-xs leading-5 text-[#74786b]"><?php echo e($desc); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
    ...
    <section class="px-3 pb-14 pt-6 sm:px-5 lg:px-8">
        <div class="mx-auto max-w-[92rem] overflow-hidden rounded-[1.5rem] bg-[#dfe2d2] p-6 sm:p-8">
            <div class="grid items-center gap-6 lg:grid-cols-[.7fr_1fr_.45fr]">
                ...
                <a href="<?php echo e(route('product-catalog')); ?>" class="inline-flex justify-center rounded-full bg-[#555a42] px-6 py-3 text-sm font-black text-white transition hover:bg-[#3f4331]">
                    Mulai belanja
                </a>
            </div>
        </div>
