                ...
                <div class="oh-card-footer">
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        <?php if($statusClass === 'pending'): ?>
                            <button type="button" wire:click="cancelOrder('<?php echo e($order->trx_id); ?>')"
                                wire:confirm="Yakin ingin membatalkan pesanan <?php echo e($order->trx_id); ?>? Stok akan dikembalikan."
