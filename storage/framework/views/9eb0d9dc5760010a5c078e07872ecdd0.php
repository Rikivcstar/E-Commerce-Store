...
<?php endif; ?>
                ...
                <?php if($isGlobalSearchVisible || $hasFiltersDialog || $hasColumnManagerDropdown): ?>
                    <div>
...
<?php endif; ?>
                        ...
                        <?php if($hasFiltersDialog || $hasColumnManagerDropdown): ?>
                    ...
                    <?php if(! $isReordering): ?>
                        ...
                        <?php if($isSelectionEnabled || count($sortableColumns)): ?>
                            <div class="fi-ta-content-header">
                                <?php if($isSelectionEnabled && ($maxSelectableRecords !== 1) && (! $isReordering)): ?>
                                    <input
...
<?php /**PATH C:\laraherd\webstore\vendor\filament\tables\resources\views\index.blade.php ENDPATH**/ ?>