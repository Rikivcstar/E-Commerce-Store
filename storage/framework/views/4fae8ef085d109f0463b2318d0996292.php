            ...
            <div class="print-container relative overflow-hidden rounded-2xl bg-white p-5 sm:p-6 shadow-md border border-[#e2e8f0]">
                ...
                <div
                    ...
                    <div class="flex items-center gap-2 no-print">
                        <!--[if BLOCK]><![endif]--><?php if($can_download_invoice): ?>
                            <a href="<?php echo e(route('account.orders.invoice', $order->trx_id)); ?>"
                ...
                <!--[if BLOCK]><![endif]--><?php if($can_claim_order): ?>
                ...
                <div class="mt-5">
                    ...
                    <div class="rounded-xl bg-[#f7f7f2] p-4 border border-[#e8e9e1]">
                        <ol class="space-y-0">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="relative flex gap-3 pb-5 last:pb-0">
                                    ...
                                    <div class="min-w-0 pt-0.5">
                                        <p class="text-xs font-bold text-[#20221b]"><?php echo e($tl['label']); ?></p>
                                        <p class="text-[10px] font-medium text-[#8c9082]">
                                            <?php echo e(($tl['timestamp'] ?? null)?->translatedFormat('d F Y, H:i')); ?>

                                        </p>
                                        <!--[if BLOCK]><![endif]--><?php if(! empty($tl['description'])): ?>
                                            <p class="mt-0.5 text-[11px] text-[#555a42] leading-relaxed">
                                                <?php echo e($tl['description']); ?>
                ...
                <div
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="mt-0.5 block font-bold text-[#20221b] text-[10px] sm:text-[11px] truncate"
                            title="<?php echo e($order->payment->label); ?>"><?php echo e($order->payment->label); ?></span>
                    </div>
                    <div class="min-w-0">
                        <span
                        ...
                        <span class="mt-0.5 block font-bold text-[#20221b] text-[10px] sm:text-[11px] truncate">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!empty($order->shipping->receipt_number)): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($tracking_url): ?>
                                    <a href="<?php echo e($tracking_url); ?>" target="_blank" rel="noopener"
                ...
                <!--[if BLOCK]><![endif]--><?php if($order->status == \App\States\SalesOrder\Pending::class): ?>
                    <div class="mt-5 pt-4 border-t border-[#f0f0eb] no-print">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($order->payment->driver === 'offline' && ! empty($paymentPayload['account_number'])): ?>
                            <div class="rounded-xl bg-[#f7f7f2] p-4 border border-[#e8e9e1] mb-4">
                                <p class="text-xs text-[#555a42] mb-3">
                                    Lakukan transfer sebesar
                                    <strong class="text-[#20221b]"><?php echo e($order->total_formatted); ?></strong> ke rekening
                                ...
                                <div class="bg-white border border-[#e2e8f0] rounded-xl divide-y divide-[#f0f0eb]">
                                    <div class="flex items-center justify-between px-4 py-3">
                                        ...
                                        <span
                                            class="text-xs font-black text-[#20221b]"><?php echo e(strtoupper($order->payment->label)); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between px-4 py-3">
                                        <span class="text-[10px] font-bold text-[#8c9082] uppercase">No. Rekening</span>
                                        <span
                                            class="text-xs font-black text-[#20221b] font-mono"><?php echo e($paymentPayload['account_number']); ?></span>
                                    </div>
                                    <div class="flex items-center justify-between px-4 py-3">
                                        <span class="text-[10px] font-bold text-[#8c9082] uppercase">a.n.</span>
                                        <span
                                            class="text-xs font-black text-[#20221b]"><?php echo e($paymentPayload['account_holder_name'] ?? '-'); ?></span>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if($order->payment->driver === 'offline'): ?>
                            <div class="rounded-xl bg-white border border-dashed border-[#d8dac9] p-4 mb-4">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($proofUrl): ?>
                                    <div class="mb-3">
                                        <img src="<?php echo e($proofUrl); ?>" alt="Bukti transfer"
...
$message = $__bag->first($__errorArgs[0]); ?>
                                        <p class="text-[11px] font-semibold text-rose-600"><?php echo e($message); ?></p>
                                    <?php unset($message);
                        ...
                        <div
                            ...
                            <div class="text-xs text-[#8c9082]">
                                ...
                                <p class="text-[11px]">Selesaikan sebelum batas waktu:
                                    <?php echo e($order->due_date_at_formatted); ?>.</p>
                            </div>
                            ...
                            <?php else: ?>
                                <span
                                    ...
                                    Silakan Hubungi CS WhatsApp: <?php echo e(config('services.contact.whatsapp')); ?>
