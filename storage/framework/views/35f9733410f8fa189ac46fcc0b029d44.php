...
<nav class="product-crumbs" aria-label="Breadcrumb">
                ...
                <a href="<?php echo e(route('product-catalog')); ?>"><?php echo e(__('Catalog')); ?></a>
            ...
            <div class="product-layout">
                ...
                <aside class="product-info-card">
                    ...
                    <div class="mt-3 flex flex-wrap items-center gap-2">
                        ...
                        <?php else: ?>
                            <span class="inline-flex items-center gap-1.5 rounded-full bg-zinc-100 px-3 py-1 text-xs font-bold text-zinc-600 border border-zinc-200"><?php echo e(__('Stok Habis')); ?></span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <span class="inline-flex items-center gap-1.5 rounded-full bg-[#f2f3ed] px-3 py-1 text-xs font-semibold text-[#555a42]">
                            ...
                            </svg><?php echo e(__('Estimasi 1-3 hari kerja')); ?></span>
                    </div>
...
?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($product->stock < 1): ?>
                        <div class="mt-4 rounded-xl border border-[#e2e8f0] bg-[#fafaf7] p-4">
                            ...
                            <?php else: ?>
                                <h3 class="text-xs font-bold text-[#20221b]"><?php echo e(__('Kabari Saya Saat Stok Tersedia')); ?></h3>
                                ...
                                <form wire:submit="subscribeStockWaitlist" class="mt-3 flex gap-2">
                                    ...
                                    <button type="submit" wire:loading.attr="disabled"
                                        class="rounded-lg bg-[#20221b] px-4 py-2 text-[11px] font-bold text-white hover:bg-black disabled:opacity-60 transition"><?php echo e(__('Notify Me')); ?></button>
                                </form>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="product-benefits">
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg><?php echo e(__('Original curated item')); ?></span>
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><path d="M2 10h20"/></svg><?php echo e(__('Checkout cepat dan aman')); ?></span>
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg><?php echo e(__('Support setelah pembelian')); ?></span>
                    </div>

                    <div class="product-info-stack">
                        <div class="product-detail-card">
                            <div class="product-detail-head">
                                <span><?php echo e(__('Description & Fit')); ?></span>
                                <span aria-hidden="true">+</span>
                            </div>
                            <div class="prose max-w-none">
                                ...
                                <?php else: ?>
                                    <p><?php echo e(__('Produk pilihan dengan detail yang dikurasi untuk penggunaan harian.')); ?></p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                        ...
                        <div class="product-detail-card">
                            ...
                            <div class="shipping-grid">
                                <div class="shipping-item">
                                    ...
                                    <span><span class="shipping-label"><?php echo e(__('Package')); ?></span><span class="shipping-value"><?php echo e(__('Regular Package')); ?></span></span>
                                </div>
                                <div class="shipping-item">
                                    <span class="shipping-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2"/><path d="M15 18H9"/><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.62l-3.48-4.35A1 1 0 0 0 17.52 8H14"/><circle cx="17" cy="18" r="2"/><circle cx="7" cy="18" r="2"/></svg></span>
                                    <span><span class="shipping-label"><?php echo e(__('Delivery')); ?></span><span class="shipping-value"><?php echo e(__('3-5 Working Days')); ?></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section aria-label="Product reviews">
                <h2 class="review-section-title">Rating &amp; <?php echo e(__('Reviews')); ?></h2>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($recommendations->count()): ?>
                <section class="recommend-section" aria-label="Recommended products">
                    <h2 class="recommend-title"><?php echo e(__('You might also like')); ?></h2>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(isset($recently_viewed) && $recently_viewed->count()): ?>
                <section class="recommend-section" aria-label="Recently viewed products">
                    <h2 class="recommend-title"><?php echo e(__('Recently viewed')); ?></h2>
                    <div class="recommend-grid">
