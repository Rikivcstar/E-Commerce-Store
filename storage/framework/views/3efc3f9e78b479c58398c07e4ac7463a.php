<div>
    <?php if(auth()->guard()->check()): ?>
        <a class="relative inline-flex h-11 items-center justify-center rounded-full bg-[#f2f3ed] px-3 text-[#555a42] transition hover:bg-[#e6e8de]"
            href="<?php echo e(route('account.wishlist')); ?>" aria-label="Wishlist" title="Wishlist">
...
<?php /**PATH C:\laraherd\webstore\resources\views\livewire\wishlist-count.blade.php ENDPATH**/ ?>