            ...
            <div class="print-container relative overflow-hidden rounded-2xl bg-white p-5 sm:p-6 shadow-md border border-[#e2e8f0]">
                ...
                <?php if($can_claim_order): ?>
                    <div class="mt-5 rounded-2xl bg-[#20221b] text-white p-5 no-print">
                        ...
                        <p class="mt-1 text-xs text-white/70 leading-relaxed">
                            Buat akun dengan email <strong class="text-white"><?php echo e($order->customer->email); ?></strong>
                ...
                <div class="mt-5">
                    <div class="flex items-center justify-between mb-2.5">
                        ...
                        <?php if(!empty($order->shipping->estimated_delivery)): ?>
                ...
                <div class="mt-5">
                    ...
                    <div class="rounded-xl bg-[#f7f7f2] p-4 border border-[#e8e9e1]">
                        <ol class="space-y-0">
                            <?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div
                    ...
                    <div class="min-w-0">
                        ...
                        <span class="mt-0.5 block font-bold text-[#20221b] text-[10px] sm:text-[11px] truncate">
                            ...
                            <?php if(!empty($order->shipping->receipt_number)): ?>
                ...
                <?php if($order->status == \App\States\SalesOrder\Pending::class): ?>
                    <div class="mt-5 pt-4 border-t border-[#f0f0eb] no-print">
                        ...
                        <?php if($order->payment->driver === 'offline' && ! empty($paymentPayload['account_number'])): ?>
                        ...
                        <?php if($order->payment->driver === 'offline'): ?>
