<a href="<?php echo e(route('product', $product->slug)); ?>" class="group block" data-aos="fade-up" data-aos-delay="30">
    ...
    <div class="mt-3 space-y-1 px-0.5">
        ...
        <div class="flex items-center justify-between gap-2">
            <p class="text-sm font-bold text-zinc-900"><?php echo e($product->price_formatted); ?></p>
