                        ...
                        <div class="mb-6">
                            <div class="flex justify-between items-baseline mb-3">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->guest()): ?>
                                    <span class="text-xs text-neutral-500">Already have an account? <a href="<?php echo e(route('login')); ?>" class="underline text-neutral-900 font-semibold">Log in</a></span>
                                <?php else: ?>
                                    <span class="text-xs text-neutral-500">Signed in as <strong class="text-neutral-900"><?php echo e(auth()->user()->name); ?></strong></span>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            <div class="linoge-field-grid two">
                                <div>
                                    <label class="linoge-label">Full name</label>
                                    <input wire:model='data.full_name' type="text" class="linoge-input <?php $__errorArgs = ['data.full_name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="linoge-error"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div>
                                    ...
                                    <input type="text" wire:model='data.email' class="linoge-input <?php $__errorArgs = ['data.email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" wire:model='data.phone' class="linoge-input <?php $__errorArgs = ['data.phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
                        ...
                        <div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                                        ...
                                        <div class="linoge-promocode-row" style="margin-top:0;">
                                            <select wire:model='address_selector.address_id' class="linoge-input" style="flex-grow:1;">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->saved_addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saved): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($saved->id); ?>"><?php echo e($saved->label); ?> &middot; <?php echo e($saved->address_line); ?>, <?php echo e($saved->city); ?></option>
                                ...
                                <p class="mb-3 text-xs text-neutral-500">
                                    <a href="<?php echo e(route('account.addresses')); ?>" class="underline text-neutral-900 font-semibold">Kelola alamat</a>
                                </p>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="linoge-field-grid">
                                <div>
                                    ...
                                    <input wire:model='data.address_line' type="text" class="linoge-input <?php $__errorArgs = ['data.address_line'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-600 <?php unset($message);
                                    ...
                                    <div x-data="{ open: false }" class="relative w-full">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($selectedRegion): ?>
                                            <div class="mt-2 p-2.5 bg-neutral-200/60 border border-neutral-300 text-xs text-neutral-800 font-medium">
                                                Selected location: <strong><?php echo e(data_get($selectedRegion, 'label')); ?></strong>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="linoge-error mb-2"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="space-y-2">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->shipping_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group_name => $shipping_method_groups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <p class="text-xs font-bold uppercase tracking-wider text-neutral-500 mt-3 mb-1"><?php echo e($group_name); ?></p>
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $shipping_method_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $shipping_method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label for="shipping_method_<?php echo e($shipping_method->hash); ?>" class="linoge-choice">
                                        <span class="flex items-center gap-3">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($shipping_method->logo_url): ?><img src="<?php echo e($shipping_method->logo_url); ?>" class="h-4 object-contain" alt="<?php echo e($shipping_method->label); ?>" /><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <span class="linoge-choice-title"><?php echo e($shipping_method->label); ?></span>
                                        </span>
                                        <span class="linoge-choice-price"><?php echo e($shipping_method->cost_formatted); ?></span>
                                    </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <aside class="linoge-summary">
                    <div class="linoge-summary-header">
                        ...
                        <span class="linoge-summary-count">(<?php echo e($cart->items->toCollection()->sum('quantity')); ?>)</span>
                    </div>
