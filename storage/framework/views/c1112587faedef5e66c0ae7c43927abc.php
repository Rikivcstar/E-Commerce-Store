...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.index','data' => ['width' => $width,'attributes' => 
...
<?php endif; ?>
<?php $component->withAttributes(['width' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($width),'attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(
        \Filament\Support\prepare_inherited_attributes(
            $attributes->class(['fi-fo-builder-block-picker']),
        )
    )]); ?>
...
<?php endif; ?>
<?php /**PATH C:\laraherd\webstore\vendor\filament\forms\resources\views\components\builder\block-picker.blade.php ENDPATH**/ ?>