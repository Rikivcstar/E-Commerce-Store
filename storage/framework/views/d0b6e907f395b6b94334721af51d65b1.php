                ...
                <section class="product-gallery" aria-label="Product gallery" x-data="{ activeImage: '<?php echo e($coverImg); ?>' }">
                    <div class="product-main-card">
                        ...
                        <div class="product-gallery-track">
                            ...
                            <?php $__currentLoopData = collect($galleryImgs)->filter(fn($img) => $img !== $coverImg)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="product-thumb cursor-pointer transition-all duration-200"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2421208102-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2421208102-1', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
            ...
            <?php if(isset($recently_viewed) && $recently_viewed->count()): ?>
