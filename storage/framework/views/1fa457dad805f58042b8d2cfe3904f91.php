    ...
    <div class="linoge-cart-page">
        <div class="linoge-cart-shell">
            ...
            <nav class="flex items-center gap-2 text-xs text-neutral-500 font-semibold uppercase tracking-wider mb-6" aria-label="Breadcrumb">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-neutral-900 transition">Home</a>
                <span>/</span>
            ...
            <div class="linoge-cart-header">
                ...
                <span class="linoge-cart-count"><?php echo e($items->sum('quantity')); ?> ITEM<?php echo e($items->sum('quantity') === 1 ? '' : 'S'); ?></span>
            </div>
                ...
                <section aria-label="Cart items">
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <article class="linoge-cart-item">
                            <!-- Product Image -->
                            <a class="linoge-cart-img-wrapper" href="<?php echo e(route('product', $product->slug)); ?>">
                                <img class="linoge-cart-img" src="<?php echo e($product->cover_url); ?>" alt="<?php echo e($product->name); ?>">
                            </a>
                            ...
                            <div class="flex flex-col justify-between py-1">
                                <div>
                                    <div class="flex justify-between items-start gap-4">
                                        <div>
                                            <a href="<?php echo e(route('product', $product->slug)); ?>" class="hover:underline">
                                                <h2 class="linoge-cart-item-title"><?php echo e($product->name); ?></h2>
                                            </a>
                                            <?php if($product->short_desc): ?>
                                                <p class="linoge-cart-item-desc"><?php echo e($product->short_desc); ?></p>
                                            <?php endif; ?>
                                        </div>
                                        <p class="linoge-cart-price"><?php echo e($product->price_formatted); ?></p>
                                    </div>
                                </div>
...
[$__name, $__params] = $__split('add-to-card', ['product' => $product,'label' => 'Update']);

$__html = app('livewire')->mount($__name, $__params, 'cart-update-'.e($item->sku).'', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('cart-remove', ['product' => $product]);

$__html = app('livewire')->mount($__name, $__params, 'remove-'.e($item->sku).'', $__slots ?? [], get_defined_vars());
...
?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="linoge-empty-bag">
                            ...
                            <div class="mt-8 max-w-xs mx-auto">
                                <a href="<?php echo e(route('product-catalog')); ?>" class="linoge-cart-btn-checkout">EXPLORE CATALOG</a>
                            </div>
                        </div>
                    <?php endif; ?>
                </section>
                ...
                <?php if(count($items) > 0): ?>
                    <aside class="linoge-cart-summary" aria-label="Order summary">
                        ...
                        <a class="linoge-cart-btn-continue" href="<?php echo e(route('product-catalog')); ?>">CONTINUE SHOPPING</a>
                    </aside>
                <?php endif; ?>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\laraherd\webstore\resources\views\livewire\cart.blade.php ENDPATH**/ ?>