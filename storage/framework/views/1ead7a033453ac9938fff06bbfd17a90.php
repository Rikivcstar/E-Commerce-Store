...
?>
            ...
            <a class="rounded-full px-4 py-2 text-sm font-bold text-[#555a42] transition hover:bg-[#f2f3ed] hover:text-[#20221b]"
                href="<?php echo e(route('page')); ?>">Info</a>
        </div>

        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('product-catalog')); ?>" :class="scrolled ? 'size-11' : 'size-10'"
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('account.orders')); ?>" :class="scrolled ? 'size-11' : 'size-10'"
                    class="hidden items-center justify-center rounded-full bg-[#f2f3ed] text-[#555a42] transition-all duration-500 hover:bg-[#e6e8de] sm:flex"
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" :class="scrolled ? 'height: 2.75rem' : 'height: 2.5rem'"
...
?>
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <form id="nav-mobile-logout-form" method="POST" action="<?php echo e(route('logout')); ?>" class="px-4 py-2">
                <?php echo csrf_field(); ?>
