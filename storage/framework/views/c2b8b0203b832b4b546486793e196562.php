    ...
    <div x-show="open" x-transition x-cloak
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('product-catalog', ['selectCategory' => [$category->id]])); ?>"
                ...
                <span class="text-xs font-bold text-[#8c9082]"><?php echo e($category->products_count); ?></span>
            </a>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('product-catalog', ['selectCategory' => [$child->id]])); ?>"
...
</div><?php /**PATH C:\laraherd\webstore\resources\views/livewire/category-menu.blade.php ENDPATH**/ ?>