        ...
        <div class="linoge-shell">
            ...
            <div class="linoge-header">
                ...
                <div class="linoge-steps">
                    <?php $__currentLoopData = [1 => 'Information', 2 => 'Delivery', 3 => 'Payment']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepNumber => $stepLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__errorArgs = ['data.full_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <?php if($this->saved_addresses->isNotEmpty()): ?>
                                    <div class="mb-4">
                                        ...
                                        <div class="linoge-promocode-row" style="margin-top:0;">
                                            <select wire:model='address_selector.address_id' class="linoge-input"
                                                ...
                                                <?php $__currentLoopData = $this->saved_addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saved): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        placeholder="Address">
                                    <?php $__errorArgs = ['data.address_line'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <div x-data="{ open: false }" class="relative w-full">
                                        ...
                                        <?php if(count($regionList) > 0): ?>
                                            <ul class="linoge-dropdown" x-show="open" x-cloak>
                                                <?php $__currentLoopData = $regionList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                    ...
                                    <?php $__errorArgs = ['data.destination_region_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <section class="linoge-section">
                        ...
                        <?php $__errorArgs = ['data.shipping_hash'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div wire:loading.remove wire:target='region_selector.region_selected' class="space-y-2">
                            <?php $__empty_1 = true; $__currentLoopData = $this->shipping_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group_name => $shipping_method_groups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <p class="text-xs font-bold uppercase tracking-wider text-neutral-500 mt-3 mb-1">
                                    <?php echo e($group_name); ?></p>
                                <?php $__currentLoopData = $shipping_method_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $shipping_method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label for="shipping_method_<?php echo e($shipping_method->hash); ?>" class="linoge-choice">
                                        <span class="flex items-center gap-3">
                                            ...
                                            <?php if($shipping_method->logo_url): ?>
                    ...
                    <section class="linoge-section">
                        ...
                        <?php $__errorArgs = ['data.payment_method_hash'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $this->payment_methods->toCollection(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $payment_method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                    ...
                    <!-- Promocode input -->
                    <?php if(empty(data_get($this->summary, 'coupon_code'))): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div wire:loading.remove wire:target='data.shipping_hash, applyCoupon, removeCoupon' class="linoge-breakdown">
                        ...
                        <?php if(data_get($this->summary, 'discount_total', 0) > 0): ?>
