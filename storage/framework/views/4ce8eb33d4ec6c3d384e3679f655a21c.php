<div>
    <style>
        ...
        @media (min-width: 900px) {
            .auth-panel-left { display: flex; flex-direction: column; }
        }
        .auth-panel-img {
            position: absolute;
            inset: 0;
        ...
        .auth-panel-step-text {
            font-size: 0.8rem;
            color: rgba(255,255,255,0.8);
            line-height: 1.5;
        }
        .auth-panel-step-text strong {
            display: block;
            color: #ffffff;
            font-weight: 600;
        }
        ...
        .auth-input-icon i[data-lucide] { width: 1rem; height: 1rem; }
        .auth-input-field {
            width: 100%;
        ...
        .auth-input-field::placeholder { color: #b0b7bf; }
        .auth-input-field:focus {
            border-color: #111111;
            background: #ffffff;
            box-shadow: 0 0 0 3px rgba(17,17,17,0.08);
        }
        .auth-input-field.error { border-color: #ef4444; }
        .auth-input-error {
            font-size: 0.72rem;
            color: #ef4444;
            font-weight: 600;
        ...
        .auth-or-line { flex: 1; height: 1px; background: #e5e7eb; }
        .auth-or-text { font-size: 0.72rem; color: #9ca3af; font-weight: 600; letter-spacing: 0.08em; }
        ...
        .auth-btn-google svg.google-icon { width: 1.1rem; height: 1.1rem; flex-shrink: 0; }
        ...
        .auth-form-footer a { color: #111111; font-weight: 700; text-decoration: none; }
        ...
        .auth-mobile-logo-icon i[data-lucide] { width: 1rem; height: 1rem; color: #fff; }
        ...
        /* Hint */
        .auth-hint { font-size: 0.7rem; color: #9ca3af; margin-top: 0.2rem; }
    </style>

    <div class="auth-split">
        
        <div class="auth-panel-left">
            <img src="<?php echo e(asset('images/final-image-ilus.png')); ?>" class="auth-panel-img" alt="Illustration">
            <div class="auth-panel-content">
                <a href="<?php echo e(url('/')); ?>" class="auth-panel-logo">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" class="size-9 object-contain rounded-full bg-white p-0.5 shadow-sm border border-amber-900/10" alt="<?php echo e(config('app.name')); ?>">
                    <span class="auth-panel-logo-text"><?php echo e(config('app.name')); ?></span>
                </a>
            </div>
        </div>
        ...
        <div class="auth-panel-right">
            <div class="auth-form-wrap">
                ...
                <a href="<?php echo e(route('auth.google')); ?>" class="auth-btn-google">
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input
                            ...
                            type="text"
                            wire:model="name"
                            class="auth-input-field <?php $__errorArgs = ['name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="auth-input-error"><?php echo e($message); ?></p><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                </div>
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input
                            ...
                            type="email"
                            wire:model="email"
                            class="auth-input-field <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input
                            ...
                            type="password"
                            wire:model="password"
                            class="auth-input-field <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input
                            ...
                            class="auth-input-field <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
<?php /**PATH C:\laraherd\webstore\resources\views\livewire\auth\customer-register.blade.php ENDPATH**/ ?>