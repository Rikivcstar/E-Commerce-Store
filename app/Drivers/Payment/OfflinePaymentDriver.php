...
class OfflinePaymentDriver implements PaymentDriverInterface
{
    ...
    {
        // Pembayaran offline tidak memerlukan proses eksternal.
        // Detail transfer sudah tersimpan di payment_payload saat order dibuat —
        // jangan ditimpa placeholder agar data pembayaran tidak hilang.
