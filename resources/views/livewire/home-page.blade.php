<div>
    ...
    <section class="relative min-h-[85vh] flex items-center overflow-hidden bg-[#0f2d5a]"
        x-data="{
            active: 0,
            slides: [
                { subtitle: 'New Collection 2026', title: 'Elevate Your', highlight: 'Style', desc: 'Discover curated collections that blend timeless elegance with modern trends. Every piece tells a story of craftsmanship and quality.', image: '{{ asset('images/carousel_bg_1.png') }}' },
                { subtitle: 'Premium Quality', title: 'Crafted For The', highlight: 'Modern You', desc: 'Experience fashion that transcends trends. Our pieces are designed with meticulous attention to detail and premium materials.', image: '{{ asset('images/carousel_bg_2.png') }}' },
                { subtitle: 'Limited Edition', title: 'Express Your', highlight: 'Identity', desc: 'Stand out from the crowd with our exclusive limited edition pieces. Bold designs for those who dare to be different.', image: '{{ asset('images/carousel_bg_3.png') }}' }
            ],
            autoplay: null,
            init() {
    ...
    <section class="border-b border-[#e2e8f0] bg-[#f8fafc]">
        <div class="max-w-[90rem] px-4 sm:px-6 lg:px-8 mx-auto py-3.5">
            <div class="flex items-center gap-8 overflow-x-auto scrollbar-hide">
                <a href="{{ route('product-catalog') }}" class="flex-shrink-0 text-sm font-semibold text-[#1e40af] pb-1 border-b-2 border-[#1e40af] whitespace-nowrap">All Products</a>
                ...
                <a href="{{ route('product-catalog') }}" class="flex-shrink-0 text-sm font-medium text-[#4b6489] hover:text-[#1e40af] pb-1 border-b-2 border-transparent hover:border-[#1e40af] whitespace-nowrap transition-all duration-200">Electronik</a>
                <a href="{{ route('product-catalog') }}" class="flex-shrink-0 text-sm font-medium text-[#4b6489] hover:text-[#1e40af] pb-1 border-b-2 border-transparent hover:border-[#1e40af] whitespace-nowrap transition-all duration-200">Phasion</a>
            </div>
        </div>
    </section>

    {{-- Featured Icons / Trust Badges --}}
    ...
    <section class="py-14">
        <div class="max-w-[90rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="flex items-end justify-between mb-10" data-aos="fade-up">
                ...
                <a href="{{ route('product-catalog') }}" class="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium text-[#4b6489] hover:text-[#1e40af] transition-colors duration-200 group">
                    View All
            ...
            <div class="mt-8 text-center sm:hidden">
                <a href="{{ route('product-catalog') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-[#1e40af] transition-colors duration-200">
                    View All Products
