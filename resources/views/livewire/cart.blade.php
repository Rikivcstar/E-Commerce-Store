  ...
  <div class="container mx-auto max-w-[85rem] w-full px-4 sm:px-6 lg:px-8 py-10">
        <div class="grid gap-10 md:grid-cols-10">
            <div class="md:col-span-7">
                <h1 class="mb-5 text-2xl font-light text-[#FEE715]">Shopping Bag</h1>
                <div class="grid gap-5">
                     ...
                     <div class="flex items-center gap-5 pb-5 border-b border-gray-200">
                        <div class="relative w-40 h-40 overflow-hidden rounded-xl">
                            ...
                            <div class="flex items-center">
                                <div class="py-5">
                                    <h3 class="text-lg font-bold text-[#FEE715]">
                                        {{ $item->product()->name }}
                                    </h3>
                                    <h2 class="text-sm text-slate-100">{{ $item->product()->short_desc }}</h2>
                                    <div class="flex items-center gap-2 my-5">

                                        <livewire:add-to-card wire:key='add-to-cart-{{ $item->sku }}' :product="$item->product()"/>

                                        <p class="px-3 py-2 mt-1 text-xl font-semibold text-slate-100 dark:text-black">
                    ...
                    @empty
                        <div class="font-bold text-slate-800 uppercase flex flex-col justify-center items-center">Product Not Found</div>
                    @endforelse
                </div>
            </div>
            <div class="md:col-span-3">
                <h1 class="mb-5 text-2xl text-[#FEE715] font-light">Order Summary</h1>
                <div class="grid gap-5 ">
                    <!-- List Group -->
                    <ul class="flex flex-col mt-3 border ">
                        <li
                    ...
                    <!-- End List Group -->
                    <button type="button" wire:click='checkout' wire:loading.attr='disable'
