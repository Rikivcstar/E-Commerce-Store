        ...
        <div class="auth-panel-right">
            <div class="auth-form-wrap">
                ...
                <div class="auth-field">
                    ...
                    @error('name')<p class="auth-input-error">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="auth-field">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input
                            ...
                            type="email"
                            wire:model="email"
                            class="auth-input-field @error('email') error @enderror"
                            placeholder="your@email.com"
                            autocomplete="email"
                        >
                    </div>
                    @error('email')<p class="auth-input-error">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="auth-field">
                    ...
                    @error('password')<p class="auth-input-error">{{ $message }}</p>@enderror
                </div>
                ...
                <div class="auth-field">
                    ...
                    @error('password_confirmation')<p class="auth-input-error">{{ $message }}</p>@enderror
                </div>
