        ...
        <div class="grid gap-5 md:gap-20 md:grid-cols-2">
            <div class="p-10">
                ...
                <div
                    ...
                    <label for="af-payment-billing-contact" class="inline-block text-sm font-medium text-white">
                        Billing contact
                    </label>
                    ...
                    <div class="grid grid-cols-2 gap-3 mt-2">
                        ...
                        <div>
                            <input type="text" wire:model='data.email'
                                ...
                                placeholder="Email">
                                @error('data.email')
                                        <p class="mt-2 text-xs text-red-600" id="hs-validation-email-error-helper">
                                {{ $message }}</p>
                                @enderror
                        </div>
                        <div>
                            ...
                            @error('data.phone')
                                <p class="mt-2 text-xs text-red-600" id="hs-validation-phone-error-helper">
                                    {{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                ...
                <div
                    ...
                    <label for="af-payment-billing-address" class="inline-block text-sm font-medium text-white">
                        Billing address
                    </label>
                    ...
                    <div class="mt-2 space-y-3">
                        ...
                        @error('data.address_line')
                            <p class="mt-2 text-xs text-red-600" id="hs-validation-billing-address-error-helper">
                                {{ $message }}</p>
                        @enderror
                        <div>
                ...
                <!-- End Section -->
                <label for="af-shipping-method" class="inline-block text-sm font-medium text-white">
                    Shipping Method
                </label>
                <div class="mt-2 space-y-3">
                ...
                <label for="af-payment-method" class="inline-block mt-5 text-sm font-medium text-white">
                    Payment Method
                </label>
                <div class="mt-2 space-y-3">
                    <div class="grid space-y-2">
            ...
            <div class="p-10">
                <h1 class="mb-5 text-2xl font-light text-white">Order Summary</h1>
                <div>
                ...
                <div class="grid gap-5">
                    ...
                    <ul class="flex flex-col mt-3">
                        <li
                            class="inline-flex items-center px-4 py-3 -mt-px text-sm text-gray-100 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:border-neutral-700 dark:text-neutral-200">
                            <div class="flex items-center justify-between w-full">
                                <span>Sub Total</span>
                                <span>{{ data_get($this->summary, 'sub_total_formatted') }}</span>
                            </div>
                        </li>
                        <li
                            class="inline-flex items-center px-4 py-3 -mt-px text-sm text-gray-100 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:border-neutral-700 dark:text-neutral-200">
                            <div class="flex items-center justify-between w-full">
                                ...
                                <span>{{ data_get($this->summary, 'shipping_total_formatted') }}</span>
                            </div>
                        </li>
                        <li
                            class="inline-flex items-center px-4 py-3 -mt-px text-sm font-semibold text-gray-100 border border-gray-200 gap-x-2 first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200">
                            <div class="flex items-center justify-between w-full">
                                <span>Total</span>
                                <span>{{ data_get($this->summary, 'grand_total_formatted') }}</span>
                            </div>
                        </li>
                    </ul>
                    <!-- End List Group -->
