    <div class="gap-2 mt-5">
      <div class="flex items-center">
            <div x-data="{ quantity: @entangle('quantity') }" class="flex gap-2 items-center my-5 w-full">
        ...
        <div class="font-bold text-xs uppercase tracking-wider mt-2.5 text-[#1e40af]">Stock: {{ $stock }} Left</div>
        @error('quantity')
