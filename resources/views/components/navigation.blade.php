<!-- ========== HEADER ========== -->
<header
    class="z-50 h-17 flex flex-wrap w-full bg-[#101820] border-b border-gray-800 md:justify-start md:flex-nowrap  ">
    <nav
        ...
        <div class="flex items-center justify-between">
            <a class="flex-none text-xl font-extrabold focus:outline-hidden focus:opacity-80 text-[#FEE715]"
        ...
        <div id="hs-header-classic"
            ...
            <div
                ...
                <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                    <a class="flex items-center p-2 text-sm text-[#FEE715] focus:outline-hidden focus:text-yellow-600 "
                    ...
                    <a class="flex items-center p-2 text-sm text-[#FEE715] hover:text-yellow-600 focus:outline-hidden focus:text-yellow-600 "
